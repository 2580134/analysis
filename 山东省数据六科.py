...
# MIN_SCORE = 0
#
# data_file = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/山东省-六科.xlsx'
# res_file = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/res-山东省-六科.xlsx'
#
# # 读取excel , 获取所有表单名字
...
line1().render("E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Print_file/山东省六科.html")