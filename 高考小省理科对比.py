...
# dir = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/各省高考一分一段表汇总/理科省市/高考小省'
# # 获取目录下所有的表
# origin_file_list = os.listdir(dir)
# #print(origin_file_list)
#
# with pd.ExcelWriter('E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/小省（理）合并.xls') as writer:
# 	# 循环遍历表格
...
data_file = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/小省（理）合并.xls'
res_file = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/res-小省（理）.xlsx'
