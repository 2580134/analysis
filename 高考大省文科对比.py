...
# dir = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/各省高考一分一段表汇总/文科省市/高考大省'
# # 获取目录下所有的表
# origin_file_list = os.listdir(dir)
# print(origin_file_list)
#
# with pd.ExcelWriter('E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/大省（文）合并.xls') as writer:
# 	# 循环遍历表格
...
# MIN_SCORE = 0
#
# data_file = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/大省（文）合并.xls'
# res_file = 'E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Data/res-大省（文）.xlsx'
#
# # 读取excel , 获取所有表单名字
...
line1().render("E:/课程设计/2020-2021-1数据采集课设/高考数据分析/高考数据分析/Print_file/高考大省（文）.html")